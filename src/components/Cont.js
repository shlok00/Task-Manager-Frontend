...
class Cont extends React.Component{
 ...
 <div className="type" style={{marginTop:"150px"}}>HabitAble<br/></div>
 <div className="type1" style={{marginTop: "400px"}}>SIMPLE.  EFFECTIVE.  MODERN.</div> <div className="type1" style={{marginTop: "30px", fontSize:"19px"}}>YOUR BRAND NEW BESTFRIEND!</div>

          <img src = {Home} style={{width: "1040px", height: "580px", marginLeft: "-20px", marginTop: "-40px" }}/>
          </div></div>
 ...
 <div className="txt"  data-aos="fade-right" style={{fontSize: "23px"}}>TASK MANAGER<br/><br/>The modern task manager tool is an interactive, creative mechanism.<br/><br/>
          - Post New Tasks!<br/>
          ...
          <Clock/>
          <br/><br/><br/><br/><br/><br/>
        <Link to="/landing"><div className="letbox" style={{marginTop:"-55px"}}><div className="qtxt">HOME</div><div className="linx"></div> </div></Link><br/>
       <Link to="/tasks"><div className="letbox"><div className="qtxt">LET'S TRACK!</div><div className="linx"></div> </div></Link> <br/><br/><br/><br/>
